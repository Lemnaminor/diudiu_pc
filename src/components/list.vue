  ...
  <div id="list_box">
    ...
    <a-list :grid="{ gutter: 16, column: 4}" :dataSource="data">
      <a-list-item slot="renderItem" slot-scope="item, index">
        <a-row>
          <a-col :span="12">
            <a-avatar icon="user" size="large" class="list_header" :src="item.header" />
